...
┃              │   copy   │  change  │  emacs   │  region  │ transpose│   yank   │  ←word   │  ↑column │  →word   │   window │  ↑list   │  ↓list   │          ┃
┃              │          │          │  state   │   map    │          │          │          │          │          │   prefix │          │          │          ┃
┠──────────────┴─┬────────┴─┬────────┴─┬────────┴─┬────────┴─┬────────┴─┬────────┴─┬────────┴─┬────────┴─┬────────┴─┬────────┴─┬────────┴─┬────────┴──────────┨
...
┃                      │  pop to   │  narrow  │   last   │   mark   │          │ ←defun   │ →defun   │ register │  yank    │   redo   │                       ┃
┃                      │  mark     │  prefix  │   thing  │   state  │          │          │          │  prefix  │ replace  │          │                       ┃
┃                      ├┄┄┄┄┄┄┄┄┄┄┄┼┄┄┄┄┄┄┄┄┄┄┼┄┄┄┄┄┄┄┄┄┄┼┄┄┄┄┄┄┄┄┄┄┼┄┄┄┄┄┄┄┄┄┄┼┄┄┄┄┄┄┄┄┄┄┼┄┄┄┄┄┄┄┄┄┄┼┄┄┄┄┄┄┄┄┄┄┼┄┄┄┄┄┄┄┄┄┄┼┄┄┄┄┄┄┄┄┄┄┤                       ┃
┃                      │ z emacs   │ x        │ c        │ v mark   │ b        │ n        │ m        │ ,        │ .        │ /        │                       ┃
┃                      │   state   │   C-x    │   C-c    │   last   │   mark   │  ←sexp   │  →sexp   │  thing   │ register │   undo   │                       ┃
┃                      │ other end │          │          │   thing  │   state  │          │          │   map    │   load   │          │                       ┃
┗━━━━━━━━━━━━━━━━━━━━━━┷━━━━━━━━━━━┷━━━━━━━━━━┷━━━━━━━━━━╅──────────┴──────────┴──────────┴──────────╆━━━━━━━━━━┷━━━━━━━━━━┷━━━━━━━━━━┷━━━━━━━━━━━━━━━━━━━━━━━┛
                                                         ┃ SPC                                       ┃
                                                         ┃                 edit map                  ┃
                                                         ┃                                           ┃
