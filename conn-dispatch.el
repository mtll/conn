...
(cl-defmethod conn-argument-update :around ((handler conn-dispatch-read-char-handlers)
                                            cmd
                                            break)
  (cl-call-next-method
   handler
...
(conn-define-argument-command ((arg conn-dispatch-select-command-handler)
                               (cmd (eql act)))
  "Reset the current prefix argument."
  ( :update (break)
