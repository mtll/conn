...
(defun conn-dispatch-select-target ()
           ...
           (conn--dispatch-read-event-message-prefixes
            `(,(lambda ()
              ...
              ,(lambda ()
                 (when-let* ((binding
                              (and
                               (funcall conn-dispatch-target-finder :retargetable)
              ...
              ,(lambda ()
                 (when-let* ((binding
                              (and (funcall conn-dispatch-target-finder :has-target)
